...
void AggregatorTwoLRF::getPointsFromLRF(const sensor_msgs::msg::LaserScan::SharedPtr lrf_msg,
	...
	std::vector<Geometry2D::Vec2>* result_points)
{
	...
	try
	{
		transformStamped = tf_buffer->lookupTransform(
			 "tf_rds", lrf_msg->header.frame_id, rclcpp::Time(0));
	}
...
void AggregatorTwoLRF::callbackLRFRear(const sensor_msgs::msg::LaserScan::SharedPtr lrf_msg)
{
